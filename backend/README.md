...
## Project Structure
    ...
    ├── integrityxchange_37300  # Django project configurations
...
1. Clone this repo and `cd integrityxchange_37300`
...
2. Clone this repo and `cd integrityxchange_37300`
